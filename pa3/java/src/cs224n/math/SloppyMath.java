...
public class SloppyMath {
  ...
  /**
   * Returns log(X+Y).  Calculation is approximate.  
   * If logX or logY is much bigger than the other, 
   * then just return the much bigger value.
   * @param logX natural log of X
   * @param logY natural log of Y
  ...
  /**
   * Returns log( sum V[i] ).
   * @param logV array of natural logs of V[i]
